        ...
        <div className="flex min-h-screen bg-bg">
                ...
                {!isPro && (
                    <div className="px-3 py-2 mb-2">
                        ...
                        >
                            ...
                            {tooltipVisible && (
                                <div className="absolute left-full ml-2 top-1/2 -translate-y-1/2 px-3 py-1.5 text-xs text-text bg-surface-hover border border-border rounded-lg shadow-lg whitespace-nowrap z-[9999]">
                                    {appCount >= 15
            ...
            {menuOpen && (
                <div className="md:hidden fixed inset-0 z-40" onClick={() => setMenuOpen(false)}>
                    ...
                    >
                        {/* Прогресс на мобиле — без tooltip */}
                        {!isPro && (
